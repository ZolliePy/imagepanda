...
<template>
    ...
    <div id="MainLayout" class="w-full h-screen">
        <div v-if="$page.url === '/'" id="TopNavHome" class="fixed z-30 md:hidden block w-full bg-white h-[61px] border-b border-b-grey-300">
            <div class="flex items-center justify-between h-full">
                <Link href="/">
                    <img class="w-[130px] mr-6 ml-3 cursor-pointer" src="/imagepanda-logo-text.png">
                </Link>
        ...
        >
            ...
            <AccountPlusOutline :size="30" class="cursor-pointer px-3" />
        </div>

        <div id="SideNav" class="fixed h-full bg-white xl:w-[280px] w-[80px] md:block hidden border-r border-r-gray-300">
            <Link href="/">
                <img class="xl:hidden block w-[25px] mt-10 ml-[25px] mb-10 cursor-pointer" src="/imagepanda-logo-small.png">
                <img class="xl:block hidden w-[120px] mt-10 ml-6 mb-10 cursor-pointer" src="/imagepanda-logo-text.png">
            </Link>
